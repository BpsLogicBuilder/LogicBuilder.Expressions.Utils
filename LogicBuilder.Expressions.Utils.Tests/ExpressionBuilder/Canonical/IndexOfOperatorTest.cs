...
{
    public class IndexOfOperatorTest
    {
        [Fact]
        public void IndexOfOperator_ThrowsWhenLeftExpressionTypeIsNotString()
        {
            //arrange
            IndexOfOperator indexOfOperator = new
            (
            ...
            //act & assert
            Assert.Throws<ArgumentException>(indexOfOperator.Build);
        }
    }
}
