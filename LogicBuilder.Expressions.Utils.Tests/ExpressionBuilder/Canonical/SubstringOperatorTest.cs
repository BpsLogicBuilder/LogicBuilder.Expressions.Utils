...
{
    public class SubstringOperatorTest
    {
        [Fact]
        public void SubstringOperator_ThrowsWhenLeftExpressionTypeIsNotString()
        {
            //arrange
            SubstringOperator substringOperator = new
            (
            ...
            //act & assert
            Assert.Throws<ArgumentException>(substringOperator.Build);
        }
    }
}
